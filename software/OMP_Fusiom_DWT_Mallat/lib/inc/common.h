...
extern  DTYPE c_kern_L[MAX_FILTER_WIDTH];
extern  DTYPE c_kern_H[MAX_FILTER_WIDTH];
extern  DTYPE c_kern_IL[MAX_FILTER_WIDTH];
extern  DTYPE c_kern_IH[MAX_FILTER_WIDTH];

extern  DTYPE c_kern_LL[MAX_FILTER_WIDTH * MAX_FILTER_WIDTH];
extern  DTYPE c_kern_LH[MAX_FILTER_WIDTH * MAX_FILTER_WIDTH];
extern  DTYPE c_kern_HL[MAX_FILTER_WIDTH * MAX_FILTER_WIDTH];
extern  DTYPE c_kern_HH[MAX_FILTER_WIDTH * MAX_FILTER_WIDTH];
...
void w_call_soft_thresh(wavelet_coeff_t& d_coeffs, DTYPE beta, w_info winfos, int do_thresh_appcoeffs, int normalize);
void w_call_hard_thresh(wavelet_coeff_t& d_coeffs, DTYPE beta, w_info winfos, int do_thresh_appcoeffs, int normalize);
void w_call_proj_linf(wavelet_coeff_t& d_coeffs, DTYPE beta, w_info winfos, int do_thresh_appcoeffs);
void w_shrink(wavelet_coeff_t&, DTYPE beta, w_info winfos, int do_thresh_appcoeffs);
